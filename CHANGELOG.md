...
### [2025-11-06] - אופיר ברנס - שיפור רספונסיביות כרטיסיות בדף הראשי

**מה שונה:**
- עדכון `index.html` (CSS רספונסיבי)
- שיפור רספונסיביות כרטיסיות תכונות (`feature-card`)
- שיפור רספונסיביות כרטיסיות שלבים (`step-card`)
- שיפור רספונסיביות כרטיסיות תצוגה (`showcase-card`)
- שיפור רספונסיביות כרטיסיות המלצות (`testimonial-card`)
- שימוש ב-`clamp()` לכל הגדלים - פונטים, padding, gaps, heights
- Grid רספונסיבי עם `minmax(clamp(...))` - מותאם לכל הרזולוציות
- שיפור רספונסיביות כותרות ותתי-כותרות
- Media queries למסכים קטנים

**למה:**
- צריך לשפר את הרספונסיביות של הכרטיסיות בדף הראשי
- הכרטיסיות לא מותאמות מספיק טוב למסכים קטנים
- צריך רספונסיביות ברמה גבוהה יותר

**השפעה:**
- ✅ כרטיסיות מותאמות לכל הרזולוציות - desktop, tablet, mobile
- ✅ Grid רספונסיבי - מותאם אוטומטית למסך
- ✅ פונטים דינמיים - `clamp()` לכל הטקסטים
- ✅ Padding ו-gaps דינמיים - מותאמים למסך
- ✅ תמונות מותאמות - height דינמי
- ✅ Media queries למסכים קטנים - התאמות נוספות
