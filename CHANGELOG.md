...
### [2025-11-06] - אופיר ברנס - שיפור ממשק ניהול מפתחות API - שיוך משתמשים מרשימה נפתחת

**מה שונה:**
- עדכון `src/components/AdminDashboard.tsx` - שיפור ממשק ניהול מפתחות API
- הוספת אפשרות לראות אילו משתמשים משויכים לכל מפתח
- הוספת dropdown לבחירת משתמש מרשימה נפתחת כדי לשייך אותו למפתח
- הוספת אפשרות להסיר משתמש ממפתח בלחיצת כפתור
- שיפור UI של ניהול מפתחות - יותר נוח וברור

**למה:**
- הממשק הקודם לא היה נוח מספיק לשיוך משתמשים למפתחות
- צורך ב-UI נוח יותר ליצירת מפתחות ושיוך משתמשים
- צורך לראות אילו משתמשים משויכים לכל מפתח

**השפעה:**
- ✅ ממשק נוח יותר ליצירת מפתחות חדשים
- ✅ אפשרות לראות אילו משתמשים משויכים לכל מפתח
- ✅ אפשרות לשייך משתמש למפתח מרשימה נפתחת
- ✅ אפשרות להסיר משתמש ממפתח בלחיצת כפתור
- ✅ UI ברור ונוח יותר
