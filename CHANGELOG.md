...
### [2025-11-06] - אופיר ברנס - תיקון טעינה כפולה - מניעת קריאה כפולה של loadUserData

**מה שונה:**
- עדכון `src/components/AppContext.tsx` - הוספת useRef למניעת טעינה כפולה
- הסרת המתנה ל-session - עכשיו משתמשים רק ב-supabaseUser הקיים
- מניעת קריאה כפולה של loadUserData על אותו משתמש

**למה:**
- loadUserData נקראת פעמיים - פעם לפני שה-session נטען ופעם אחרי
- טעינה אינסופית של דף הבית
- הבעיה הייתה שה-useEffect פעל פעמיים על אותו משתמש

**השפעה:**
- ✅ מניעת טעינה כפולה של אותו משתמש
- ✅ שימוש רק ב-supabaseUser הקיים (לא מחכים)
- ✅ טעינה מהירה יותר
- ✅ מניעת טעינה אינסופית
