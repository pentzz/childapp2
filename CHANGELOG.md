...
### [2025-11-06] - אופיר ברנס - וידוא שמירת כל היצירות ל-saved_content + תצוגת מנהל

**מה שונה:**
- עדכון `src/components/StoryCreator.tsx`
- עדכון `src/components/WorkbookCreator.tsx`
- עדכון `src/components/ContentGallery.tsx`
- הוספת שמירה ל-`saved_content` לכל היצירות (stories, workbooks, learning_plans, worksheets)
- יצירת sections אוטומטית מ-content_data לתצוגה משופרת
- שיפור תצוגת מנהל - מנהל יכול לראות את כל היצירות של כל המשתמשים
- סטטיסטיקות מפורטות - מספר יצירות לפי סוג
- תצוגה משופרת - כל היצירות נראות נכון עם sections

**למה:**
- צריך לוודא שכל היצירות נשמרות באפליקציה עצמה (ל-saved_content)
- צריך צפייה נוחה ביצירות
- המנהל צריך לראות את כל היצירות של כל המשתמשים
- צריך לשפר את הארגון והצפייה

**השפעה:**
- ✅ כל היצירות נשמרות ל-saved_content - stories, workbooks, learning_plans, worksheets
- ✅ יצירת sections אוטומטית מ-content_data לתצוגה משופרת
- ✅ מנהל יכול לראות את כל היצירות של כל המשתמשים
- ✅ סטטיסטיקות מפורטות - מספר יצירות לפי סוג
- ✅ תצוגה משופרת - כל היצירות נראות נכון עם sections
- ✅ שמירה כפולה - גם ל-tables המקוריים וגם ל-saved_content
